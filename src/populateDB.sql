...
INSERT INTO developer_skills (developer_id, skill_id) SELECT developer_id, skill_id FROM
  (SELECT d.developer_id, s.skill_id FROM developers d, skills s
...
INSERT INTO developer_projects (developer_id, project_id) SELECT developer_id, project_id FROM
  (SELECT d.developer_id, p.project_id FROM developers d, projects p
...
INSERT INTO company_projects VALUES (
  (SELECT company_id FROM companies WHERE company_name = 'Company_7'),
  (SELECT project_id FROM projects WHERE project_name = 'Project_8'));

INSERT INTO company_projects VALUES (
  (SELECT company_id FROM companies WHERE company_name = 'Company_8'),
  (SELECT project_id FROM projects WHERE project_name = 'Project_9'));

INSERT INTO company_projects VALUES (
  (SELECT company_id FROM companies WHERE company_name = 'Company_9'),
